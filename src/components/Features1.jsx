...
import feature1 from "../assets/images/american-airlines.png";
import feature2 from "../assets/images/jetblue.png";
import feature3 from "../assets/images/booking.png";
import feature4 from "../assets/images/hotel.png";
        ...
        <div className="flex flex-wrap items-center 2xl:w-[1450px] xl:w-[1300px] w-11/12 mx-auto md:pl-4 xl:pr-16 xl:pl-16">
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              ...
              Effortless Extraction of Travel Data
                            </h2>
              ...
              <ul className="mb-6 text-primaryText">
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Upload PDFs or images of your travel documents</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                ...
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Supports flight purchases, activity reservations, hotel reservations, and car reservations</span>
                </li>
              </ul>
            </div>
          </div>
